 ...
 */
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.ElementViewHolder> {
    private final String LOGVAR = "FavoritesAdapter";
    ...
    public FavoritesAdapter(ArrayList listData, MainActivity mainActivity) {
